...
<div id="slides" class="carousel slide" data-ride="carousel" data-aos="fade-up"
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img class="image" src="img/background.jpeg">
			<div class="carousel-caption">
				<h1 class="display-2"> Books & Booze </h1>
				<h3>A place where you get the best of both worlds!</h3>
		...
		<div class="carousel-item">
			<img class="image" src="img/background2.jpeg">
		</div>
		<div class="carousel-item">
			<img class="image" src="img/background3.jpeg">
		</div>
	</div>
</div>
